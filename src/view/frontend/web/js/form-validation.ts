...
/**
 * Writes into the `<p class="field__error">` the field macro already rendered,
 * emptying it rather than removing it: the node owns the `aria-describedby`
 * target and the styles, and one that is injected on demand has neither.
 */
